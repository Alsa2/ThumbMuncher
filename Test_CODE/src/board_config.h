...
#define PIN_I2C_SDA                     0u
#define PIN_I2C_SCL                     1u
...
// -----------------------------------------------------------------------------
// Current sensor defaults: INA226 reading shunt voltage directly.
// Set CURRENT_SENSOR_ENABLED to 0 if the INA226 is not populated.
// -----------------------------------------------------------------------------
#define CURRENT_SENSOR_ENABLED          1
#define INA226_I2C_ADDR                 0x40u
#define INA226_SHUNT_RES_OHM            0.050f
