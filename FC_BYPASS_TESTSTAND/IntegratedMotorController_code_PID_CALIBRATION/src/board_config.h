...
#define THROTTLE_PRIME_US               1400u   // post-spin prime pulse
...
// -----------------------------------------------------------------------------
// Default throttle/RPM feedforward curve; the custom CAN protocol may update these at runtime
//   0%   -> 1900 us -> 1800 RPM
