...
// TELEMETRY_RATE payload, 8 bytes:
//   byte 0..1: telemetry A period in ms (RPM/state/output)
//   byte 2..3: telemetry B period in ms (target/feedforward/PID)
//   byte 4..5: telemetry C period in ms (temperature/current/bus/runtime)
//   byte 6..7: reserved
